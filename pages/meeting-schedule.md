...
<table class="ic-Table ic-Table--condensed ic-Table--hover-row" style="margin-top:20px">
  ...
  <tbody>
    <tr>
      ...
      <td><a href="https://csbsju.instructure.com/courses/10454/assignments/91537">{% icon edit %}</a> <a href="{% file labs/03/SampleCode.lhs %}">{% icon zipped %}</a></td>
      <td>Lab 03</td>
      <td></td>
    </tr>
    <tr>
  ...
  <tbody>
    <tr>
      ...
      <td><a href="{% file labs/04/Lab.pdf %}">{% icon edit %}</a> <a href="{% file labs/04/SampleCode.lhs %}">{% icon zipped %}</a></td>
      <td>Lab 04</td>
      <td></td>
    </tr>
    <tr>
  ...
  <tbody>
    <tr>
      ...
      <td><a href="https://csbsju.instructure.com/courses/10454/assignments/102627">{% icon edit %}</a> <a href="{% file labs/09/StarterCode.lhs %}">{% icon zipped %}</a></td>
      <td>Lab 09</td>
      <td></td>
    </tr>
    <tr>
  ...
  <tbody>
    <tr>
      ...
      <td><a href="{% file labs/10/Lab.pdf %}">{% icon edit %}</a> <a href="{% file labs/10/MontyHall.lhs %}">{% icon zipped %}</a></td>
      <td>Lab 10</td>
      <td></td>
    </tr>
    <tr>
